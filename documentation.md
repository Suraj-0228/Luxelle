...
| `username`| String | Unique, Required | User login handle |
| `password`| String | Required | Hashed password |
| `phone` | String | Optional | Contact number |
| `address` | Object | Nested | Contains street, city, state, zip, country |
| `isAdmin` | Boolean | Default: false | Admin privileges flag |
| `isBlocked`| Boolean | Default: false | Account suspension status |
...
| `category`| String | Enum | Bags, Watches, Jewelry, Sunglasses, Belts |
| `price` | Number | Required | Product cost |
| `colors` | Array | Optional | List of available colors |
| `material`| String | Optional | Material composition |
| `image` | String | Required | URL/Path to product image |
| `description`| String| Optional | Detailed product information |
...
| `items` | Array | Required | List of products, quantity, and selectedColor |
| `totalAmount`| Number | Required | Final bill amount (Subtotal + Tax + Shipping) |
| `subtotal`| Number | Default: 0 | Cost of items before tax/shipping |
| `tax` | Number | Default: 0 | Tax amount |
| `shippingCost`| Number | Default: 0 | Cost of shipping |
| `shippingAddress`| Object | Required | Full address details |
| `billingAddress`| Object | Required | Full billing details |
| `paymentMethod`| String | Enum | 'Card', 'UPI', 'COD' |
| `paymentStatus`| String | Default: 'Pending'| Payment state |
| `orderStatus`| String | Default: 'Confirmed'| Enum: Confirmed, Processing, Shipped, Delivered, Cancelled |
