...
@Component({
    ...
    <div class="min-h-screen bg-white animate-fadeIn">
        <div class="max-w-4xl mx-auto px-6 sm:px-12 py-16 md:py-24">
            <h1 class="text-3xl lg:text-5xl font-serif text-gray-900 tracking-tight mb-2">Terms of Service</h1>
            <p class="text-gray-400 font-light text-sm mb-12">Last Updated: July 2, 2026</p>

            <div class="space-y-10 text-sm text-gray-600 font-light leading-relaxed">
                <!-- Section 1 -->
                <section>
                    <h2 class="text-lg font-serif font-bold text-gray-900 mb-3 border-b border-gray-100 pb-2">1. Introduction & Scope</h2>
                    <p class="mb-4">
                ...
                <!-- Section 2 -->
                <section>
                    <h2 class="text-lg font-serif font-bold text-gray-900 mb-3 border-b border-gray-100 pb-2">2. Account Registration & Security</h2>
                    <p class="mb-4">
                ...
                <!-- Section 3 -->
                <section>
                    <h2 class="text-lg font-serif font-bold text-gray-900 mb-3 border-b border-gray-100 pb-2">3. Product Details, Pricing, & Taxes</h2>
                    <p class="mb-4">
                ...
                <!-- Section 4 -->
                <section>
                    <h2 class="text-lg font-serif font-bold text-gray-900 mb-3 border-b border-gray-100 pb-2">4. Payment Processing & Gateways</h2>
                    <p class="mb-4">
                ...
                <!-- Section 5 -->
                <section>
                    <h2 class="text-lg font-serif font-bold text-gray-900 mb-3 border-b border-gray-100 pb-2">5. Intellectual Property Rights</h2>
                    <p>
                ...
                <!-- Section 6 -->
                <section>
                    <h2 class="text-lg font-serif font-bold text-gray-900 mb-3 border-b border-gray-100 pb-2">6. Limitation of Liability</h2>
                    <p>
                ...
                <!-- Section 7 -->
                <section>
                    <h2 class="text-lg font-serif font-bold text-gray-900 mb-3 border-b border-gray-100 pb-2">7. Governing Law & Dispute Resolution</h2>
                    <p>
